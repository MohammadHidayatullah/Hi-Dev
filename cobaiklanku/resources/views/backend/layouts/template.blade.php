...
<head>
    ...
    <!-- full calendar css-->
    <link href="{{ asset('backend/css/fullcalendar/fullcalendar/bootstrap-fullcalendar,css') }}" rel="stylesheet" />
    <link href="{{ asset('backend/css/fullcalendar/fullcalendar/fullcalendar,css') }}" rel="stylesheet" />
    <!-- easy pie chart-->
