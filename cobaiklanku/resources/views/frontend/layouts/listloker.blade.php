        ...
        <div class="row justify-content-center">
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    <img src="{{ asset ('frontend/assets/images/loker1.jpeg') }}" class="card-img-top" class="img-fluid" alt="...">
                    <div class="card-body">
                      ...
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Esse, asperiores? </p>
            ...
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    <img src="{{ asset ('frontend/assets/images/loker2.jpg') }}" class="card-img-top" class="img-fluid" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
            ...
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    <img src="{{ asset ('frontend/assets/images/loker3.jpg') }}" class="card-img-top" class="img-fluid" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Distinctio, commodi!</p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    <img src="{{ asset ('frontend/assets/images/loker4.jpg') }}" class="card-img-top" class="img-fluid" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, amet?</p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Culpa, reiciendis. </p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde, perferendis!</p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem, rerum. </p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Webinar Politik</h5>
                      <p class="card-text" style="overflow: hidden; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical;">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, ipsa? </p>
                      <a href="#" class="btn btn-outline-info">Read More</a>
                    </div>
                </div>
            </div>
